  ...
  <body class="app header-fixed sidebar-fixed aside-menu-fixed sidebar-lg-show">
    <header class="app-header navbar">
      ...
      <ul class="nav navbar-nav d-md-down-none">
        ...
        <li class="nav-item px-3">
          <a class="nav-link" href="/admin/tool">Quản lý Tool</a>
        </li>
      </ul>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/admin/game">
                <i class="nav-icon icon-pencil"></i> Game</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="/admin/tool">
                <i class="nav-icon icon-pencil"></i> Quản lý Tool</a>
            </li>
